		...
		<div class="relative w-full max-w-md" in:fade>
			...
			<div class="relative overflow-hidden rounded-3xl border-4 border-s-black bg-white">
				...
				<div class="space-y-6 p-8">
					...
					<button
						class="mt-4 cursor-pointer w-full rounded-xl border-4 border-s-black bg-s-black py-4 text-sm font-black text-white uppercase transition-all hover:bg-p-green hover:text-s-black active:translate-y-1 active:shadow-none"
					>
