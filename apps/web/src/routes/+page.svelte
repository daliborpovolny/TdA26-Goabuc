<script lang="ts">
	...
	import SimpleGreenLink from '$lib/components/SimpleGreenLink.svelte';
...
<main class="min-h-screen bg-s-white">
	<section
		class="relative overflow-hidden border-b-8 border-s-black bg-p-blue px-6 py-20 text-white"
	>
