<script lang="ts">
	...
	let {
		...
		content?: string;
		onclick?: (() => void) | ((e: Event) => Promise<void>);
		bgcolor?: string;
		hv_bgcolor?: string;
		uppercase?: boolean;
		children?: Snippet;
...
<button
	...
	class="cursor-pointer {border
		? 'rounded-xl border-4 border-s-black'
		...
		? 'hover:translate-x-1 hover:translate-y-1 active:translate-x-1.5 active:translate-y-1.5'
